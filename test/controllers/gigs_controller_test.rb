...
class GigsControllerTest < ActionController::TestCase
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post :create, gig: { details: @gig.details, paid: @gig.paid, pictures: @gig.pictures, price: @gig.price, user_id: @gig.user_id }
    end
  ...
  test "should update gig" do
    patch :update, id: @gig, gig: { details: @gig.details, paid: @gig.paid, pictures: @gig.pictures, price: @gig.price, user_id: @gig.user_id }
    assert_redirected_to gig_path(assigns(:gig))
  end
